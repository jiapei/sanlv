...
@url = "http://www.unifly.com.cn/products/73/0.aspx"
...
#20 1..15
0.upto(8) do |i|
	@url = "http://www.unifly.com.cn/products/73/#{i}.aspx"
	...
	rows =  @doc.xpath('//div[@class = "cpr_1"]/a/@href')

	puts rows.length

	rows.each do |row|
	  @file_to_write.puts  "http://www.unifly.com.cn#{row.to_s.strip_tag.strip}"
